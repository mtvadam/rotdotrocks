...
export default function TradeDetailError({ error, reset }: ErrorProps) {
  useEffect(() => {
    console.error(error)
  }, [error])

  return (
    <div className="min-h-[calc(100vh-64px)] bg-darkbg-950 flex items-center justify-center px-4">
      <div className="w-full max-w-md text-center">
        ...
        <p className="text-gray-400 mb-8 leading-relaxed">
          This trade could not be loaded right now. It may have been removed, or there was a temporary issue fetching it.
        </p>
