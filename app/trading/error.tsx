...
export default function TradingError({ error, reset }: ErrorProps) {
  useEffect(() => {
    console.error(error)
  }, [error])
    ...
    <div className="min-h-[calc(100vh-64px)] bg-darkbg-950 flex items-center justify-center px-4">
      <div className="w-full max-w-md text-center">
        ...
        <p className="text-gray-400 mb-8 leading-relaxed">
          The Trading Hub ran into an unexpected issue. Your trades are safe — this is just a temporary glitch.
        </p>
